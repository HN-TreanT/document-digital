...
print("check static root", STATIC_ROOT)
...
def _parse_db_settings() -> dict:
    databases = {
        "default": {
            "ENGINE": "django.db.backends.mysql",
            "HOST": os.getenv("PAPERLESS_DBHOST", "localhost"),
            "PORT": os.getenv("PAPERLESS_DBPORT", "3306"),
            "NAME": os.getenv("PAPERLESS_DBNAME", "paperless"),
            "USER": os.getenv("PAPERLESS_DBUSER", "paperless"),
            "PASSWORD": os.getenv("PAPERLESS_DBPASS", "paperless"),
            "OPTIONS": {},
    ...
    # Cấu hình SSL nếu có
    # ssl_mode = os.getenv("PAPERLESS_DBSSLMODE")
    # print("check ssl mode:", ssl_mode)
    # if ssl_mode:
    #     databases["default"]["OPTIONS"].update({
    #         "ssl_mode": ssl_mode,
    #         "ssl": {
    ...
    # Thiết lập timeout nếu có
    db_timeout = os.getenv("PAPERLESS_DB_TIMEOUT")
    if db_timeout:
        databases["default"]["OPTIONS"]["connect_timeout"] = int(db_timeout)
